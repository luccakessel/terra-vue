...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GreenSense — Monitoreo inteligente de invernaderos" },
      {
        name: "description",
        content:
          "Sistema de monitoreo y control en tiempo real de sensores de invernaderos: humedad, temperatura, luz y riego.",
      },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* AuthProvider mantiene el token en memoria y expone useAuth() a toda la app. */}
      <AuthProvider>
